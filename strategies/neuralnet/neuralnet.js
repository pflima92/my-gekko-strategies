...
var strategy = {
  ...
  setNormalizeFactor: function (candle) {
    ...
    console.debug('Set normalization factor to', this.scale);
  },
  ...
  check: function (candle) {
    if (this.predictionCount > this.settings.min_predictions) {
      if (
        ...
        console.debug('>>>>>>>>>> STOPLOSS triggered <<<<<<<<<<');
        this.advice('short');
      }
      ...
      if ('buy' !== this.prevAction && signal === false && meanAlpha > this.settings.threshold_buy) {
        ...
        console.debug("Buy - Predicted variation: ", meanAlpha);
        return this.advice('long');
      }
      else if
        ('sell' !== this.prevAction && signal === true && meanAlpha < this.settings.threshold_sell && signalSell) {

        console.debug("Sell - Predicted variation: ", meanAlpha);
    ...
    console.debug('Triggered stoploss', this.stoplossCounter, 'times');
  }
};
